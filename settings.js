...
creator = '@dandisubhani_' // Nama 
port = 8080 //port host
LimitApikey = 2000 // Limit Apikey default

//___________ ┏  Database Mongodb Setting  ┓ ___________\\

keymongodb = 'mongodb+srv://danz:Adandisi12@cluster0.s1ghvhb.mongodb.net/?retryWrites=true&w=majority' //process.env.mongodb //example "mongodb+srv://user:password@name_database.mongodb.net/?retryWrites=true&w=majority";
...
sendemail = 'danzedih@gmail.com' //process.env.sendemail //Email SMTP
fromsendemail = 'danzedih@gmail.com' //process.env.fromsendemail // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = 'Adandsi12' //process.env.sendpwmail // Password Email SMTP
domain = 'danzdev.my.id'// domain website tanpa http or https
...
recaptcha_key_1 = '6LdePqsnAAAAACf6CwYJFqMjeQUJ3JD7PbRJomse' //process.env.recaptcha_key_1
recaptcha_key_2 = '6LdePqsnAAAAADvB30mjFMlK79kL08k7XrXX_J0J' //process.env.recaptcha_key_2
